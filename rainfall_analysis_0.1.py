...
# --- 1. CONFIGURATION ---
RAINFALL_THRESHOLD_INCHES = 0.1  # <--- THRESHOLD CHANGED TO 0.1
...
def main():
    print(f"--- RCGMP Analysis (Rainfall >= {RAINFALL_THRESHOLD_INCHES} inches) ---")
    results_list = []
    ...
    if results_list:
        ...
        output_filename = 'correlation_results_0.1.csv'
